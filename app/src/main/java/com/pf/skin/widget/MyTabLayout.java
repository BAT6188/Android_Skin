...
import com.pf.skin.R;
import com.pf.skin_core.SkinViewSupport;
...
public class MyTabLayout extends TabLayout implements SkinViewSupport {
    ...
    public MyTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TabLayout,
                defStyleAttr, 0);
        tabIndicatorColorResId = a
                .getResourceId(R.styleable.TabLayout_tabIndicatorColor, 0);
    ...
    public void applySkin() {
        ...
        if (tabTextColorResId != 0) {
            ColorStateList tabTextColor = SkinResources.getInstance()
                    .getColorStateList(tabTextColorResId);
